...
const Home = () => {
    ...
    return (
        <div class="main">
            <div class="outgrid-text" style={{top:"13vh",left:"32.76vw",fontSize:"23vh",backgroundColor:"transparent"}}><h2>pauly</h2></div>
            ...
            <div class="outgrid-text" onClick={handleUiux} style={{top:"37vh",left:"33.5vw",fontSize:"3vh",backgroundColor:"transparent",cursor:"pointer"}}><h2>ui/ux</h2></div>
